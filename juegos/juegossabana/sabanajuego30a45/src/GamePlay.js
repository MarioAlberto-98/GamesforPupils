...
function n6(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n7, this, 's37','p37','s37');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e6, this, 's35','p35','s35');
...
function n12(){
  ...
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e12, this, 's39','p39','s39');
    ...
    text = game.add.text(game.world.centerX- 150, 170, "  21\n+     \n  22\n _______");
  text.anchor.setTo(0.5);
