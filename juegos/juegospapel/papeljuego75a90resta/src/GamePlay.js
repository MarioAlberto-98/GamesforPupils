...
function preload() {
    ...
    game.load.atlas('button','assets/images/san60a90.png','assets/images/san60a90.json');
...
//75
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e1, this, 's76','p76','s76');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e1, this, 's77','p77','s77');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',n2, this, 's75','p75','s75');
  


  text = game.add.text(game.world.centerX- 150, 170, "  77\n-     \n   2\n _______");
...
//75
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',n3, this, 's75','p75','s75');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e2, this, 's76','p76','s76');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e2, this, 's77','p77','s77');
  

  text = game.add.text(game.world.centerX- 150, 170, "  76\n-     \n   1\n _______");
  text.anchor.setTo(0.5);
...
//76
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e3, this, 's78','p78','s78');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e3, this, 's76','p76','s76');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',n4, this, 's77','p77','s77');
  


  text = game.add.text(game.world.centerX- 150, 170, "  79\n-     \n   2\n _______");
  text.anchor.setTo(0.5);
...
//76
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',n5, this, 's76','p76','s76');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e4, this, 's77','p77','s77');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e4, this, 's78','p78','s78');
  


  text = game.add.text(game.world.centerX- 150, 170, "  80\n-     \n   4\n _______");
  text.anchor.setTo(0.5);
...
//77
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e5, this, 's78','p78','s78');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e5, this, 's76','p76','s76');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',n6, this, 's77','p77','s77');
  


  text = game.add.text(game.world.centerX- 150, 170, "  87\n-     \n  10\n _______");
  text.anchor.setTo(0.5);
...
//78
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e6, this, 's78','p78','s78');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e6, this, 's77','p77','s77');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',n7, this, 's79','p79','s79');
...
//79
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',n8, this, 's79','p79','s79');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e7, this, 's80','p80','s80');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e7, this, 's78','p78','s78');
  


  text = game.add.text(game.world.centerX- 150, 170, "   85\n-     \n   6\n _______");
  text.anchor.setTo(0.5);
...
//80
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e8, this, 's81','p81','s81');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e8, this, 's79','p79','s79');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',n9, this, 's80','p80','s80');
...
function n9(){
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',n10, this, 's81','p81','s81');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e9, this, 's80','p80','s80');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e9, this, 's82','p82','s82');
...
//82
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e10, this, 's81','p81','s81');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e10, this, 's83','p83','s83');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',n11, this, 's82','p82','s82');
  

  text = game.add.text(game.world.centerX- 150, 170, "  89\n-     \n   7\n _______");
  text.anchor.setTo(0.5);
...
//84
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',n12, this, 's84','p84','s84');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e11, this, 's85','p85','s85');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e11, this, 's86','p86','s86');
  


  text = game.add.text(game.world.centerX- 150, 170, "  90\n-     \n   6\n _______");
  text.anchor.setTo(0.5);
...
//85
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',n13, this, 's85','p85','s85');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e12, this, 's86','p86','s86');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e12, this, 's87','p87','s87');
  


  text = game.add.text(game.world.centerX- 150, 170, "  94\n-     \n   9\n _______");
  text.anchor.setTo(0.5);
...
//87
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e13, this, 's86','p86','s86');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e13, this, 's88','p88','s88');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',n14, this, 's87','p87','s87');
  


  text = game.add.text(game.world.centerX- 150, 170, "  95\n-     \n   8\n _______");
  text.anchor.setTo(0.5);
...
//89
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e14, this, 's88','p88','s88');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e14, this, 's87','p87','s87');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',n15, this, 's89','p89','s89');
  

  text = game.add.text(game.world.centerX- 150, 170, "  99\n-     \n  10\n _______");
  text.anchor.setTo(0.5);
...
//90
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',e15, this, 's89','p89','s89');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',g, this, 's90','p90','s90');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e15, this, 's88','p88','s88');
  

  text = game.add.text(game.world.centerX- 150, 170, "  105\n+     \n   15\n _______");
  text.anchor.setTo(0.5);
