...
//76
  ...
  uno=game.add.button(game.world.centerX - -10, 120, 'button',n4, this, 's76','p76','s76');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e3, this, 's77','p77','s77');
  


  text = game.add.text(game.world.centerX- 150, 170, "  38\n+     \n  38\n _______");
  text.anchor.setTo(0.5);
...
//78
  ...
  cero=game.add.button(game.world.centerX - -130, 32, 'button',n7, this, 's78','p78','s78');
  uno=game.add.button(game.world.centerX - -10, 120, 'button',e6, this, 's77','p77','s77');
  dos=game.add.button(game.world.centerX -  -130, 182, 'button',e6, this, 's79','p79','s79');
  

  text = game.add.text(game.world.centerX- 150, 170, "  39\n+     \n  39\n _______");
  text.anchor.setTo(0.5);
...
//84
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  17\n+     \n  67\n _______");
  text.anchor.setTo(0.5);
...
//87
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  41\n+     \n  46\n _______");
  text.anchor.setTo(0.5);
