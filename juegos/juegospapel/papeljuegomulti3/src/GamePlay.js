...
function n1(){
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e1, this, 's2','p2','s2');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',n2, this, 's6','p6','s6');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e1, this, 's3','p3','s3');
  


  text = game.add.text(game.world.centerX- 0, 200, "3  x  2");
...
function n2(){
  ...
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e2, this, 's2','p2','s2');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n3, this, 's3','p3','s3');
  


  text = game.add.text(game.world.centerX- 0, 200, "3  x  1");
  text.anchor.setTo(0.5);
...
//4
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e3, this, 's10','p10','s10');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e3, this, 's11','p11','s11');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n4, this, 's12','p12','s12');
  


  text = game.add.text(game.world.centerX- 0, 200, "3  x  4");
  text.anchor.setTo(0.5);
...
cero=game.add.button(game.world.centerX - -100, 380, 'button',n5, this, 's9','p9','s9');
uno=game.add.button(game.world.centerX - 70, 380, 'button',e4, this, 's8','p8','s8');
dos=game.add.button(game.world.centerX -  250, 380, 'button',e4, this, 's5','p5','s5');



text = game.add.text(game.world.centerX- 0, 200, "3  x  3");
text.anchor.setTo(0.5);
...
//6
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e5, this, 's10','p10','s10');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',n6, this, 's18','p18','s18');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e5, this, 's19','p19','s19');
  


  text = game.add.text(game.world.centerX- 0, 200, "3  x  6");
  text.anchor.setTo(0.5);
...
//7
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e6, this, 's9','p9','s9');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e6, this, 's14','p14','s14');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n7, this, 's15','p15','s15');
  


  text = game.add.text(game.world.centerX- 0, 200, "3  x  5");
  text.anchor.setTo(0.5);
...
//7
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e7, this, 's19','p19','s19');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',n8, this, 's24','p24','s24');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e7, this, 's23','p23','s23');
  


  text = game.add.text(game.world.centerX- 0, 200, "3  x  8");
  text.anchor.setTo(0.5);
...
cero=game.add.button(game.world.centerX - -100, 380, 'button',n9, this, 's21','p21','s21');
uno=game.add.button(game.world.centerX - 70, 380, 'button',e8, this, 's22','p22','s22');
dos=game.add.button(game.world.centerX -  250, 380, 'button',e8, this, 's24','p24','s24');



text = game.add.text(game.world.centerX- 0, 200, "3  x  7");
text.anchor.setTo(0.5);
...
//10
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e9, this, 's28','p28','s28');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e9, this, 's29','p29','s29');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n10, this, 's30','p30','s30');
  


  text = game.add.text(game.world.centerX- 0, 200, "3  x  10");
  text.anchor.setTo(0.5);
...
//10
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',g, this, 's27','p27','s27');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e10, this, 's20','p20','s20');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e10, this, 's29','p29','s29');
  


  text = game.add.text(game.world.centerX- 0, 200, "3  x  9");
  text.anchor.setTo(0.5);
