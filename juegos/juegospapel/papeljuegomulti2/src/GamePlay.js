...
function n1(){
  ...
  uno=game.add.button(game.world.centerX - 70, 380, 'button',n2, this, 's4','p4','s4');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e1, this, 's3','p3','s3');
  


  text = game.add.text(game.world.centerX- 0, 200, "2  x  2");
...
function n2(){
  ...
  uno=game.add.button(game.world.centerX - 70, 380, 'button',n3, this, 's2','p2','s2');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e2, this, 's3','p3','s3');
  


  text = game.add.text(game.world.centerX- 0, 200, "2  x  1");
  text.anchor.setTo(0.5);
...
//4
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e3, this, 's5','p5','s5');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e3, this, 's6','p6','s6');
...
//6
  ...
  uno=game.add.button(game.world.centerX - 70, 380, 'button',n6, this, 's12','p12','s12');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e5, this, 's11','p11','s11');
  


  text = game.add.text(game.world.centerX- 0, 200, "2  x  6");
  text.anchor.setTo(0.5);
...
//7
  ...
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n7, this, 's10','p10','s10');
  


  text = game.add.text(game.world.centerX- 0, 200, "2  x  5");
  text.anchor.setTo(0.5);
...
//7
  ...
  uno=game.add.button(game.world.centerX - 70, 380, 'button',n8, this, 's16','p16','s16');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e7, this, 's17','p17','s17');
...
cero=game.add.button(game.world.centerX - -100, 380, 'button',n9, this, 's14','p14','s14');
uno=game.add.button(game.world.centerX - 70, 380, 'button',e8, this, 's13','p13','s13');
dos=game.add.button(game.world.centerX -  250, 380, 'button',e8, this, 's16','p16','s16');



text = game.add.text(game.world.centerX- 0, 200, "2  x  7");
text.anchor.setTo(0.5);
...
//10
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e9, this, 's18','p18','s18');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e9, this, 's19','p19','s19');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n10, this, 's20','p20','s20');
...
//10
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',g, this, 's18','p18','s18');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e10, this, 's10','p10','s10');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e10, this, 's19','p19','s19');
  


  text = game.add.text(game.world.centerX- 0, 200, "2  x  9");
  text.anchor.setTo(0.5);
