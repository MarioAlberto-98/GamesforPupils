...
function n1(){
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',n2, this, 's2','p2','s2');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e1, this, 's6','p6','s6');
...
function n2(){
  ...
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e2, this, 's7','p7','s7');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e2, this, 's8','p8','s8');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n3, this, 's9','p9','s9');
...
//4
  ...
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e3, this, 's9','p9','s9');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n4, this, 's8','p8','s8');
  


  text = game.add.text(game.world.centerX- 0, 200, "2  x  4");
  text.anchor.setTo(0.5);
...
cero=game.add.button(game.world.centerX - -100, 380, 'button',n5, this, 's6','p6','s6');
...
text = game.add.text(game.world.centerX- 0, 200, "2  x  3");
text.anchor.setTo(0.5);
...
//6
  ...
  uno=game.add.button(game.world.centerX - 70, 380, 'button',n6, this, 's16','p16','s16');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',e5, this, 's19','p19','s19');
  


  text = game.add.text(game.world.centerX- 0, 200, "2  x  8");
  text.anchor.setTo(0.5);
...
//7
  cero=game.add.button(game.world.centerX - -100, 380, 'button',e6, this, 's19','p19','s19');
  uno=game.add.button(game.world.centerX - 70, 380, 'button',e6, this, 's14','p14','s14');
  dos=game.add.button(game.world.centerX -  250, 380, 'button',n7, this, 's20','p20','s20');
  


  text = game.add.text(game.world.centerX- 0, 200, "2  x  10");
  text.anchor.setTo(0.5);
