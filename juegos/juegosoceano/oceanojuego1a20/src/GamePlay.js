...
function preload() {
    ...
    game.load.image('an7','assets/images/a8.png');
...
function n1(){
  ...
  images = game.add.image(660, 300, 'an7');
...
function n7(){
  ...
  image = game.add.image(210, 460, 'an1');
  images = game.add.image(660, 300, 'an7');
...
function n8(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e8, this, 's9','p9','s9');
  ...
  image = game.add.image(310, 460, 'an1');;
  images = game.add.image(660, 300, 'an7');
...
function n10(){
  ...
  image = game.add.image(400, 400, 'an1');
  images = game.add.image(660, 300, 'an7');
...
//image = game.add.image(400, 330, 'an1');
  ...
  image = game.add.image(420, 330, 'an1');
  images = game.add.image(660, 300, 'an7');
...
function n14(){
  ...
  image = game.add.image(490, 330, 'an1');
  images = game.add.image(660, 300, 'an7');
...
function n15(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',g, this, 's20','p20','s20');
  ...
  image = game.add.image(540, 330, 'an1');
  images = game.add.image(640, 300, 'an7');
