...
function preload() {
    ...
    game.load.image('asteroide','assets/images/a8.png');
    ...
    game.load.image('an3','assets/images/a21.png');
...
//89
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e13, this, 's89','p89','s89');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n14, this, 's87','p87','s87');
  


  text = game.add.text(game.world.centerX- 150, 170, "112 - 25");
  text.anchor.setTo(0.5);
