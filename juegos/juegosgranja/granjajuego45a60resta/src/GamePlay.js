...
function preload() {
    ...
    game.load.image('an1','assets/images/a9.png');
    game.load.image('an2','assets/images/a2.png');
    game.load.image('an3','assets/images/a17.png');
...
//46
  ...
  text = game.add.text(game.world.centerX- 150, 170, "48 - 2");
...
//47
  ...
  text = game.add.text(game.world.centerX- 150, 170, "52 - 5");
  text.anchor.setTo(0.5);
...
cero=game.add.button(game.world.centerX - -100, 32, 'button',n4, this, 's47','p47','s47');
  ...
  text = game.add.text(game.world.centerX- 150, 170, "54 - 7");
  text.anchor.setTo(0.5);
...
//48
  ...
  text = game.add.text(game.world.centerX- 150, 170, "55 - 7");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "59 - 10");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "57 - 7");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "55 - 3");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "59 - 6");
  text.anchor.setTo(0.5);
...
//54
  ...
  text = game.add.text(game.world.centerX- 150, 170, "60 - 6");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "70 - 15");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "63 - 7");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "58 - 2");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "64 - 7");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "69 - 12");
  text.anchor.setTo(0.5);
...
text = game.add.text(game.world.centerX- 150, 170, "62 - 3");
  text.anchor.setTo(0.5);
