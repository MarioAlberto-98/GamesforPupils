...
function preload() {
    ...
    game.load.image('asteroide','assets/images/a5.png');
...
function n12(){
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e12, this, 's13','p13','s13');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n13, this, 's10','p10','s10');
