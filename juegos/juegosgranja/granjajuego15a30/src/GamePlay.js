...
function preload() {
    ...
    game.load.image('asteroide','assets/images/a3.png');
    ...
    game.load.image('an3','assets/images/a14.png');
...
function n3(){
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n4, this, 's16','p16','s16');
