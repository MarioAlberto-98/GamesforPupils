...
function preload() {
    ...
    game.load.image('an3','assets/images/a20.png');
...
function n1(){
  ...
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e1, this, 's2','p2','s2');
  
  text = game.add.text(game.world.centerX- 150, 170, "1 - 0");
...
function n2(){
  ...
  text = game.add.text(game.world.centerX- 150, 170, "3 - 1");
  text.anchor.setTo(0.5);
...
function n3(){
  ...
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n4, this, 's2','p2','s2');
  


  text = game.add.text(game.world.centerX- 150, 170, "4 - 2");
  text.anchor.setTo(0.5);
...
function n4(){
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n5, this, 's3','p3','s3');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e4, this, 's4','p4','s4');
  


  text = game.add.text(game.world.centerX- 150, 170, "6 - 3");
  text.anchor.setTo(0.5);
...
function n5(){
  ...
  uno=game.add.button(game.world.centerX -  -70, 132, 'button',n6, this, 's4','p4','s4');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e5, this, 's5','p5','s5');
...
function n6(){
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n7, this, 's5','p5','s5');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e6, this, 's4','p4','s4');
  


  text = game.add.text(game.world.centerX- 150, 170, "6 - 1");
  text.anchor.setTo(0.5);
...
function n7(){
  ...
  tres=game.add.button(game.world.centerX - -100, 32, 'button',e7, this, 's6','p6','s6');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n8, this, 's5','p5','s5');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e7, this, 's4','p4','s4');
  

  text = game.add.text(game.world.centerX- 150, 170, "7 - 2");
  text.anchor.setTo(0.5);
...
uno=game.add.button(game.world.centerX - -100, 32, 'button',e8, this, 's5','p5','s5');
tres=game.add.button(game.world.centerX - -70, 132, 'button',e8, this, 's6','p6','s6');
dos=game.add.button(game.world.centerX -  -100, 232, 'button',n9, this, 's8','p8','s8');
  

text = game.add.text(game.world.centerX- 150, 170, "9 - 1");
  text.anchor.setTo(0.5);
...
function n9(){
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e9, this, 's5','p5','s5');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n10, this, 's8','p8','s8');
  

  text = game.add.text(game.world.centerX- 150, 170, "10 - 2");
  text.anchor.setTo(0.5);
...
function n10(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e10, this, 's3','p3','s3');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n11, this, 's9','p9','s9');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e10, this, 's7','p7','s7');
  



  text = game.add.text(game.world.centerX- 150, 170, "9 - 0");
  text.anchor.setTo(0.5);
...
///
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n12, this, 's10','p10','s10');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e11, this, 's9','p9','s9');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e11, this, 's8','p8','s8');
  

  text = game.add.text(game.world.centerX- 150, 170, "14 - 4");
  text.anchor.setTo(0.5);
...
function n12(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e12, this, 's11','p11','s11');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n13, this, 's13','p13','s13');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e12, this, 's10','p10','s10');
  


  text = game.add.text(game.world.centerX- 150, 170, "15 - 2");
  text.anchor.setTo(0.5);
...
function n13(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n14, this, 's13','p13','s13');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e13, this, 's14','p14','s14');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e13, this, 's15','p15','s15');
  


  text = game.add.text(game.world.centerX- 150, 170, "13 - 0");
  text.anchor.setTo(0.5);
...
function n14(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n15, this, 's13','p13','s13');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e14, this, 's14','p14','s14');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e14, this, 's15','p15','s15');
  

  text = game.add.text(game.world.centerX- 150, 170, "17 - 4");
  text.anchor.setTo(0.5);
...
function n15(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e15, this, 's14','p14','s14');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',g, this, 's15','p15','s15');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e15, this, 's16','p16','s16');
