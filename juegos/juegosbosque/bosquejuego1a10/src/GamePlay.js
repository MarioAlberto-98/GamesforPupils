...
function n1(){
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  0\n+     \n  1\n _______");
...
function n3(){
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n4, this, 's3','p3','s3');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e3, this, 's2','p2','s2');
...
function n4(){
  ...
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n5, this, 's4','p4','s4');
...
function n6(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n7, this, 's6','p6','s6');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e6, this, 's5','p5','s5');
...
function n7(){
  ...
  tres=game.add.button(game.world.centerX - -100, 32, 'button',n8, this, 's6','p6','s6');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e7, this, 's5','p5','s5');
...
function n11(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n12, this, 's9','p9','s9');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e11, this, 's8','p8','s8');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e11, this, 's6','p6','s6');
...
function n12(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e12, this, 's5','p5','s5');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n13, this, 's9','p9','s9');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e12, this, 's8','p8','s8');
...
function n13(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e13, this, 's10','p10','s10');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e13, this, 's5','p5','s5');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n14, this, 's9','p9','s9');
...
function n14(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e14, this, 's7','p7','s7');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e14, this, 's9','p9','s9');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n15, this, 's10','p10','s10');
...
function n15(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e15, this, 's8','p8','s8');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',g, this, 's10','p10','s10');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e15, this, 's7','p7','s7');
