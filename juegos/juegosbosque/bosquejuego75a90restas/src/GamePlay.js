...
//76
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n2, this, 's76','p76','s76');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e1, this, 's75','p75','s75');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e1, this, 's77','p77','s77');
...
//76
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n3, this, 's76','p76','s76');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e2, this, 's77','p77','s77');
...
//78
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  83\n-     \n   5\n _______");
  text.anchor.setTo(0.5);
...
//78
  ...
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n5, this, 's78','p78','s78');
...
//80
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n7, this, 's80','p80','s80');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e6, this, 's81','p81','s81');
...
//82
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n8, this, 's82','p82','s82');
...
//82
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e8, this, 's83','p83','s83');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n9, this, 's82','p82','s82');
...
//84
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n11, this, 's84','p84','s84');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e10, this, 's85','p85','s85');
...
//86
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  97\n-     \n  11\n _______");
  text.anchor.setTo(0.5);
...
//86
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n13, this, 's86','p86','s86');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e12, this, 's87','p87','s87');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e12, this, 's88','p88','s88');
  


  text = game.add.text(game.world.centerX- 150, 170, "  100\n-     \n   14\n _______");
  text.anchor.setTo(0.5);
...
//88
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n14, this, 's88','p88','s88');
...
//88
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n15, this, 's88','p88','s88');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e14, this, 's89','p89','s89');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e14, this, 's87','p87','s87');
  


  text = game.add.text(game.world.centerX- 150, 170, "  104\n-     \n   16\n _______");
  text.anchor.setTo(0.5);
...
//90
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  120\n-     \n   30\n _______");
  text.anchor.setTo(0.5);
