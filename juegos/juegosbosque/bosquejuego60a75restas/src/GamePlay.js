...
//61
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  65\n-     \n   4\n _______");
...
//61
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e2, this, 's62','p62','s62');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e2, this, 's63','p63','s63');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n3, this, 's61','p61','s61');
  


  text = game.add.text(game.world.centerX- 150, 170, "  67\n-     \n   6\n _______");
  text.anchor.setTo(0.5);
...
//63
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n4, this, 's63','p63','s63');
...
//65
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n6, this, 's65','p65','s65');
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  75\n-     \n  10\n _______");
  text.anchor.setTo(0.5);
...
function n6(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e6, this, 's64','p64','s64');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n7, this, 's65','p65','s65');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e6, this, 's67','p67','s67');
  


  text = game.add.text(game.world.centerX- 150, 170, "  74\n-     \n   9\n _______");
  text.anchor.setTo(0.5);
...
//67
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n8, this, 's67','p67','s67');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e7, this, 's68','p68','s68');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e7, this, 's66','p66','s66');
...
//69
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n10, this, 's69','p69','s69');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e9, this, 's67','p67','s67');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e9, this, 's68','p68','s68');
...
//69
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  78\n-     \n   9\n _______");
  text.anchor.setTo(0.5);
...
//71
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n12, this, '71','p71','s71');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e11, this, 's69','p69','s69');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e11, this, 's70','p70','s70');
...
// 71
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e12, this, 's70','p70','s70');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n13, this, 's71','p71','s71');
...
//73
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n14, this, 's73','p73','s73');
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  81\n-     \n   8\n _______");
  text.anchor.setTo(0.5);
...
//73
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n15, this, 's73','p73','s73');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e14, this, 's74','p74','s74');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e14, this, 's72','p72','s72');
...
//75
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',g, this, 's75','p75','s75');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e15, this, 's74','p74','s74');
