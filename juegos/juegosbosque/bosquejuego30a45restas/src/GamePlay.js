...
function preload() {
    ...
    game.load.image('an1','assets/images/a2.png');
...
function n1(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n2, this, 's31','p31','s31');
...
function n2(){
  ...
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n3, this, 's34','p34','s34');
...
function n3(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n4, this, 's33','p33','s33');
...
function n4(){
  ...
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n5, this, 's33','p33','s33');
...
function n6(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n7, this, 's36','p36','s36');
...
function n7(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n8, this, 's38','p38','s38');
...
function n8(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n9, this, 's38','p38','s38');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e8, this, 's34','p34','s34');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e8, this, 's39','p39','s39');
...
function n10(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n11, this, 's40','p40','s40');
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  50\n-     \n  10\n _______");
  text.anchor.setTo(0.5);
...
function n11(){
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  52\n+     \n  11\n _______");
  text.anchor.setTo(0.5);
...
function n12(){
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n13, this, 's41','p41','41');
...
function n14(){
  ...
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n15, this, 's43','p43','s43');
  


  text = game.add.text(game.world.centerX- 150, 170, "  44\n-     \n   1\n _______");
  text.anchor.setTo(0.5);
...
function n15(){
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  51\n-     \n   6\n _______");
  text.anchor.setTo(0.5);
