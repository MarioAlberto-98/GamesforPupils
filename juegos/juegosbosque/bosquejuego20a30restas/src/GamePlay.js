...
function preload() {
    ...
    game.load.image('ovni2','assets/images/a8.png');
...
function n9(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e9, this, 's26','p26','s26');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n10, this, 's27','p27','s27');
...
function n10(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e10, this, 's27','p27','s27');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e10, this, 's26','p26','s26');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n11, this, 's25','p25','s25');
...
function n12(){
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',n13, this, 's28','p28','s28');
  uno=game.add.button(game.world.centerX -  -70, 132, 'button',e12, this, 's25','p25','s25');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e12, this, 's27','p27','s27');
...
function n14(){
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  40\n-     \n  11\n _______");
  text.anchor.setTo(0.5);
