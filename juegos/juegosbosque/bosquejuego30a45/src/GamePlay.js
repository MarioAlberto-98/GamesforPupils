...
function n2(){
  ...
  uno=game.add.button(game.world.centerX - -70, 132, 'button',n3, this, 's31','p31','s31');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',e2, this, 's34','p34','s34');
...
function n15(){
  ...
  text = game.add.text(game.world.centerX- 150, 170, "  22\n+     \n  23\n _______");
  text.anchor.setTo(0.5);
