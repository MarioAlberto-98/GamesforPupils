...
text = game.add.text(game.world.centerX, 220, "   Restas en el Espacio  ");
...
function niveluno(){
  ...
  text = game.add.text(game.world.centerX, 205, "  3\n-     \n  1\n _______");
  text.anchor.setTo(0.5);
...
function niveldos(){
  ...
  uno=game.add.button(game.world.centerX - 60, 375, 'button',correctonivel2, this, 'unouno','uno','unouno');
  dos=game.add.button(game.world.centerX -  -145, 375, 'button',errorniveldos, this, 'dosuno','dos','dosuno');
  ...
  text = game.add.text(game.world.centerX, 205, "  4\n-     \n  3\n _______");
  text.anchor.setTo(0.5);
...
function niveltres(){
  ...
  cero=game.add.button(game.world.centerX - 280, 375, 'button',correctonivel3, this, 'tresuno','tres','tresuno');
  uno=game.add.button(game.world.centerX - 60, 375, 'button',errorniveltres, this, 'unouno','uno','unouno');
  dos=game.add.button(game.world.centerX -  -145, 375, 'button',errorniveltres, this, 'dosuno','dos','dosuno');
  ...
  text = game.add.text(game.world.centerX, 205, "  5\n-     \n  2\n _______");
  text.anchor.setTo(0.5);
...
text.events.onInputOut.add(out, this);
 ...
 text2 = game.add.text(650, 35, " Nivel 3/15");
  ...
  function nivelcuatro(){
    ...
    uno=game.add.button(game.world.centerX - 60, 375, 'button',correctonivel4, this, 'tresuno','tres','tresuno');
    dos=game.add.button(game.world.centerX -  -145, 375, 'button',errornivelcuatro, this, 'dosuno','dos','dosuno');
    ...
    text = game.add.text(game.world.centerX, 205, "  6\n-     \n  3\n _______");
    text.anchor.setTo(0.5);
 ...
 text2 = game.add.text(650, 35, " Nivel 4/15");
  ...
  text2.fontSize = 25;
    ...
    function nivelcinco(){
      ...
      cero=game.add.button(game.world.centerX - 280, 375, 'button',correctonivel5, this, 'cincouno','cinco','cincouno');
      uno=game.add.button(game.world.centerX - 60, 375, 'button',errornivelcinco, this, 'cuatrouno','cuatro','cuatrouno');
      dos=game.add.button(game.world.centerX -  -145, 375, 'button',errornivelcinco, this, 'dosuno','dos','dosuno');
      ...
      text = game.add.text(game.world.centerX, 205, "  7\n-     \n  2\n _______");
      text.anchor.setTo(0.5);
...
function nivelseis(){
  ...
  cero=game.add.button(game.world.centerX - 280, 375, 'button',errornivelseis, this, 'tresuno','tres','tresuno');
  uno=game.add.button(game.world.centerX - 60, 375, 'button',errornivelseis, this, 'cuatrouno','cuatro','cuatrouno');
  dos=game.add.button(game.world.centerX -  -145, 375, 'button',correctonivel6, this, 'cincouno','cinco','cincouno');
  ...
  text = game.add.text(game.world.centerX, 205, "  8\n-     \n  3\n _______");
  text.anchor.setTo(0.5);
...
text.events.onInputOut.add(out, this);
 ...
 text2 = game.add.text(650, 35, " Nivel 6/15");
  ...
  function nivelsiete(){
    ...
    cero=game.add.button(game.world.centerX - 280, 375, 'button',correctonivel7, this, 'sieteuno','siete','sieteuno');
    uno=game.add.button(game.world.centerX - 60, 375, 'button',errornivelsiete, this, 'ochouno','ocho','ochouno');
    dos=game.add.button(game.world.centerX -  -145, 375, 'button',errornivelsiete, this, 'seisuno','seis','seisuno');
 ...
 text2 = game.add.text(650, 35, " Nivel 7/15");
  ...
  text2.fontSize = 25;
    ...
    function nivelocho(){
      ...
      cero=game.add.button(game.world.centerX - 280, 375, 'button',errornivelocho, this, 'ochouno','ocho','ochouno');
      uno=game.add.button(game.world.centerX - 60, 375, 'button',correctonivel8, this, 'sienteuno','siete','sieteuno');
      dos=game.add.button(game.world.centerX -  -145, 375, 'button',errornivelocho, this, 'nueveuno','nueve','nueveuno');
...
function nivelnueve(){
  ...
  cero=game.add.button(game.world.centerX - 280, 375, 'button',correctonivel9, this, 'nueveuno','nueve','nueveuno');
  uno=game.add.button(game.world.centerX - 60, 375, 'button',errornivelnueve, this, 'ochouno','ocho','ochouno');
  dos=game.add.button(game.world.centerX -  -145, 375, 'button',errornivelnueve, this, 'diezuno','diez','diezuno');
  ...
  text = game.add.text(game.world.centerX, 205, "  10\n-     \n   1\n _______");
  text.anchor.setTo(0.5);
...
text.events.onInputOut.add(out, this);
 ...
 text2 = game.add.text(650, 35, " Nivel 9/15");
  ...
  function niveldiez(){
    ...
    cero=game.add.button(game.world.centerX - 280, 375, 'button',errorniveldiez, this, 'ochouno','ocho','ochouno');
    uno=game.add.button(game.world.centerX - 60, 375, 'button',errorniveldiez, this, 'nueveuno','nueve','nueveuno');
    dos=game.add.button(game.world.centerX -  -145, 375, 'button',ganaste, this, 'diezuno','diez','diezuno');
