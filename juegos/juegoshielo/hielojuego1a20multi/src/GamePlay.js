...
function preload() {
    ...
    game.load.image('an7','assets/images/a6.png');
...
function n1(){
  ...
  image = game.add.image(30, 400, 'an1');
...
//2
  ...
  image = game.add.image(60, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//4
  ...
  image = game.add.image(90, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//5
  ...
  image = game.add.image(120, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//5
  ...
  image = game.add.image(150, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//7
  ...
  image = game.add.image(180, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
cero=game.add.button(game.world.centerX - -100, 32, 'button',n8, this, 's25','p25','s25');
uno=game.add.button(game.world.centerX - -70, 132, 'button',e7, this, 's23','p23','s23');
dos=game.add.button(game.world.centerX -  -100, 232, 'button',e7, this, 's21','p21','s21');
...
text = game.add.text(game.world.centerX- 150, 170, "  5\nx     \n  5\n _______");
  ...
  image = game.add.image(210, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
text = game.add.text(game.world.centerX- 150, 170, "  4\nx     \n  6\n _______");
  ...
  image = game.add.image(240, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//9
  ...
  image = game.add.image(270, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//11
  ...
  image = game.add.image(340, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//image = game.add.image(400, 330, 'an1');
image = game.add.image(380, 400, 'an1');
images = game.add.image(630, 370, 'an7');
...
//15
  ...
  cero=game.add.button(game.world.centerX - -100, 32, 'button',e12, this, 's7','p7','s7');
  uno=game.add.button(game.world.centerX - -70, 132, 'button',e12, this, 's9','p9','s9');
  dos=game.add.button(game.world.centerX -  -100, 232, 'button',n13, this, 's8','p8','s8');
...
image = game.add.image(450, 400, 'an1');
images = game.add.image(630, 370, 'an7');
...
//17
  ...
  image = game.add.image(490, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//18
  ...
  image = game.add.image(560, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
...
//20
  ...
  image = game.add.image(590, 400, 'an1');
  images = game.add.image(630, 370, 'an7');
